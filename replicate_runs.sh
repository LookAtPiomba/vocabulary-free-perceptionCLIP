...
sh scripts/srun_twostep_compose.sh ImageNet ViT-B/16 imagenet_main_template imagenet_factor_templates art,medium 0 object imagnet_ours_wy_vit16
sh scripts/srun_twostep_compose.sh ImageNet ViT-B/16 imagenet_main_template imagenet_factor_templates art,medium,background 0 object imagnet_ours_wy_vit16
sh scripts/srun_twostep_compose.sh ImageNet ViT-B/16 imagenet_main_template imagenet_factor_templates art,medium,background,quality 0 object imagnet_ours_wy_vit16
