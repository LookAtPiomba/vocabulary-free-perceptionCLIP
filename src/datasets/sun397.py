...
class Sun397:
    ...
    def __init__(self,
        ...
        if not os.path.exists(os.path.join(location, 'Sun397')):
            self.test_dataset = torchvision.datasets.SUN397(root=location, transform=preprocess, download=True)
        else:
            self.test_dataset = torchvision.datasets.SUN397(root=location, transform=preprocess, download=False)
